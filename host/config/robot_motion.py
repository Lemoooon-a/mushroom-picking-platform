...
MOTION = MotionRuntimeConfig(
    slide=AxisMotionProfile(
        default_velocity=96.0,  # mm/s; 80% of the STM32 120 mm/s limit
        default_acceleration=180.0,  # mm/s²; NOT PRODUCTION-CALIBRATED
        arrival=ArrivalConfig(0.2, 0.2, 0.05, 180.0),
    ),
    z=AxisMotionProfile(
        default_velocity=16.0,  # mm/s; 80% of the STM32 20 mm/s limit
    ...
    slide_motion_limits=LinearAxisMotionLimits(120.0, 180.0),
    z_motion_limits=LinearAxisMotionLimits(20.0, 25.0),
)
