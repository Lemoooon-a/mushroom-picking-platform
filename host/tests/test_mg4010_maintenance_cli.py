...
class MG4010MaintenanceTests(unittest.TestCase):
    def runtime(self) -> MagicMock:
        ...
        runtime.shoulder_joint.config.name = "shoulder"
        runtime.elbow_joint.config.name = "elbow"
    ...
    def test_confirmation_gate_and_no_disable_option(self, create) -> None:
        ...
        source = Path(__file__).resolve().parents[1] / "scripts/maintenance/mg4010_joint.py"
